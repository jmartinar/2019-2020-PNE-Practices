...
def process_client(s):
    ...
    elif "info/C" in req_line: # req_line is GET /info/A HTTP/1.1
        FILENAME = "C.html"
        body = read(FOLDER + FILENAME)  # read() is the function read_fasta_data()
    elif "info/T" in req_line: # req_line is GET /info/A HTTP/1.1
        FILENAME = "T.html"
        body = read(FOLDER + FILENAME)  # read() is the function read_fasta_data()
    elif "info/G" in req_line: # req_line is GET /info/A HTTP/1.1
        FILENAME = "G.html"
        body = read(FOLDER + FILENAME)  # read() is the function read_fasta_data()
    else:
        body = ""
